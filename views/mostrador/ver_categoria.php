                    ...
                    if (isset($_POST['cerrarSesion'])) {
                        ...
                        if (isset($_SESSION['nickname'])) {
                            ...
                            if ($consulta['tipo'] == "cliente") {
                                ...
                                echo '<span id="saludo">Hola <span id="nickname">' . $nickname . '</span></span><br>' .
                                    '<a href="../administracion/menu.php">Administración</a><form action="../../index.php" method="POST">
                                <input type="submit" value="Salir" name="cerrarSesion">
                            </form>';
    ...
    <main>
        <div class='productos'>
            ...
            if (isset($_GET['categoria'])) {
                ...
                $resultado = mysqli_query($conexion, "select idProducto,nombre,precio from producto where categoria = $categoria");

                while ($consulta = mysqli_fetch_array($resultado)) { ?>

                    <div class="cajaProducto">
                        <img src="../../php/helpers/ver_imagen.php?id=<?php echo $consulta['idProducto']; ?>" alt="<?php echo $consulta['nombre']; ?>">
                        <span>$<?php echo $consulta['precio']; ?></span>
                        <p><a href="ver_producto.php?id=<?php echo $consulta['idProducto']; ?>"><?php echo $consulta['nombre']; ?></a></p>
                    </div>
                <?php
                }
            } else {
                $resultado = mysqli_query($conexion, "select idProducto,nombre,precio from producto");
