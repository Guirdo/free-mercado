...
function cargar_imagen($foto,$idProducto){
    ...
    if ((isset($_FILES[$foto])) && ($_FILES[$foto] != '')) {
        ...
        //Creando el query
        $query = "INSERT INTO imagen (idProductoI,nombreArchivo ,extension ,binario ) VALUES ($idProducto,'$fileName' ,'$fileExtension' ,'$contenido' )";
        //Ejecutando el Query
